...
CREATE TABLE empleado (
  ...
  empleado_nombre    VARCHAR NOT NULL,
  empleado_telefono  VARCHAR NOT NULL,
  empleado_direccion VARCHAR NOT NULL,
  empleado_email     VARCHAR NOT NULL,
  empleado_cargo     VARCHAR NOT NULL,
  empleado_salario   DECIMAL NOT NULL,
  jefe_empleado_id   VARCHAR,
...
CREATE TABLE estacion (
  estacion_nombre      VARCHAR NOT NULL,
  estacion_ubicacion   VARCHAR NOT NULL,
  director_empleado_id VARCHAR UNIQUE,
...
CREATE TABLE bus (
  bus_serial    VARCHAR NOT NULL,
  bus_tipo      VARCHAR NOT NULL,
...
CREATE TABLE tarjeta (
  ...
  tarjeta_estado VARCHAR                                             NOT NULL,
...
CREATE TABLE pasajero (
  ...
  pasajero_nombre    VARCHAR        NOT NULL,
  pasajero_telefono  VARCHAR        NOT NULL,
  pasajero_direccion VARCHAR        NOT NULL,
  pasajero_email     VARCHAR        NOT NULL,
  tarjeta_id         VARCHAR UNIQUE NOT NULL,
...
CREATE TABLE turno (
  bus_serial            VARCHAR        NOT NULL,
  turno_turno           VARCHAR        NOT NULL,
  conductor_empleado_id VARCHAR UNIQUE NOT NULL,
...
VALUES ('E31', 'EXPRESO CHIMINANGOS - UNIVERSIDADES', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('E37', 'CHIMINANGOS - UNIDAD DEPORTIVA', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('E52', 'NUEVO LATIR - TERMINAL CALIPSO - TERMINAL', TRUE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('T47A', 'T. ANDRES SANIN - UNIDAD DEPORTIVA', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('T47B', 'T. ANDRES SANIN - UNIDAD DEPORTIVA', TRUE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P12A', 'UNIVERSIDADES - TERMINAL ANDRES SANIN - CENTRO EMPRESA', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P14A', 'UNIVERSIDADES - TERMINAL ANDRES SANIN', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('P21B', 'TERMINAL MENGA - UNIVERSIDADES', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P24A', 'TERMINAL MENGA - TERMINAL ANDRES SANIN', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P24C', 'TERMINAL MENGA - TERMINAL ANDRES SANIN - DECEPAZ', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('P27C', 'TERMINAL MENGA - UNIVERSIDADES', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P30A', 'FLORA INDUSTRIAL - TERMINAL MENGA - CENTRO', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('P40A', 'TERMINAL ANDRES SANIN - CENTRO', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P47A', 'TERMINAL ANDRES SANIN - UNIDAD DEPORTIVA', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P47B', 'T. ANDRES SANIN - UNIDAD DEPORTIVA', TRUE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('P47C', 'T. ANDRES SANIN - CAPRI', TRUE);

INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('E27B', 'AV LAS AMERICAS - UNIDAD DEPORTIVA', FALSE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P10B', 'UNIVERSIDADES - EL INGENIO - CENTRO', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('P10D', 'UNIVERSIDADES - CENTRO', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P17', 'P.U.J. - ICESI - UNIDAD DEPORTIVA', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P21A', 'UNIVERSIDADES - CENTRO - AV LAS AMERICAS', FALSE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P52A', 'NUEVO LATIR - AV. DE LAS AMERICAS', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('P52D', 'CIUDAD CORDOBA - CENTRO - TERMINAL', FALSE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A05', 'LAS AMERICAS - C.A.M. - LA PORTADA', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('A06', 'AGUACATAL - SAN BOSCO', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A07A', 'CONQUISTADORES - SANTA ELENA - CENTRO', FALSE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A17A', 'UAO - SAN MARTIN - UNIVERSIDADES', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A21', 'CIUDADELA FLORALIA - TERMINAL MENGA', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A22', 'BRISAS DE LOS ALAMOS - TERMINAL MENGA', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A23', 'CIUDADELA LOS ALAMOS - TERMINAL MENGA', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('A33', 'CIUDADELA FLORALIA - CHIMINANGOS', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A35B', 'JORGE ELIECER - FLORA INDUSTRIAL', FALSE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A42A', 'TERMINAL ANDRES SANIN - LA CASONA - NUEVO LATIR', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A42B', 'LA CASONA - TERMINAL ANDRES SANIN', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A44A', 'MANUELA BELTRAN - TERMINAL ANDRES SANIN', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A44B', 'PUERTAS DEL SOL - TERMINAL ANDRES SANIN', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A45A', 'ALFONSO LOPEZ - TERMINAL ANDRES SANIN', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('A47', 'PIZAMOS - TERMINAL ANDRES SANIN', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A53', 'AMANECER - LOS LAGOS - ANDRES SANIN', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A71', 'LOS CHORROS - TERMINAL CAÑAVERALEJO', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A72A', 'JARDINES DE LA AURORA - TERMINAL CAÑAVERALEJO', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A72B', 'EL CORTIJO - TERMINAL CAÑAVERALEJO', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado) VALUES ('A73', 'NAPOLES - CALDAS - CAÑAVERALEJO', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A75', 'LA SIRENA - TERMINAL CAÑAVERALEJO', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A85', 'SANTA MONICA - TERMINAL ANDRES SANIN', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A12A', 'ALTOS DE LA LUISA - ESTACION MELENDEZ', FALSE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A12D', 'ALTOS DE SANTA ELENA - ESTACION MELENDEZ', FALSE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A18', 'HACIENDA EL CASTILLO - UNIVERSIDADES', FALSE);
...
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A52', 'HOSPITAL DUARTE CANCINO - NUEVO LATIR', FALSE);
INSERT INTO ruta (ruta_nombre, ruta_descripcion, ruta_estado)
VALUES ('A55', 'COMPARTIR - MANUELA BELTRAN - NUEVO LATIR', FALSE);
...
INSERT INTO estacion_ruta (estacion_nombre, ruta_nombre)
VALUES ('CENTRO', 'E37'), ('CENTRO', 'T31'), ('CENTRO', 'T40'), ('CENTRO', 'T50'), ('CENTRO', 'P30A'),
  ('CENTRO', 'P40A');
INSERT INTO estacion_ruta (estacion_nombre, ruta_nombre)
VALUES ('CALIPSO', 'E52'), ('CALIPSO', 'T50'), ('CALIPSO', 'T57A'), ('CALIPSO', 'P21B'), ('CALIPSO', 'P47B');
INSERT INTO estacion_ruta (estacion_nombre, ruta_nombre)
VALUES ('NUEVO LATIR', 'T50'), ('NUEVO LATIR', 'T57A'), ('NUEVO LATIR', 'E52'), ('NUEVO LATIR', 'P12A'),
  ('NUEVO LATIR', 'P47C');
INSERT INTO estacion_ruta (estacion_nombre, ruta_nombre)
...
INSERT INTO estacion_ruta (estacion_nombre, ruta_nombre)
VALUES ('CHIMINANGOS', 'E31'), ('CHIMINANGOS', 'E37'), ('CHIMINANGOS', 'T31'), ('CHIMINANGOS', 'P12A'),
  ('CHIMINANGOS', 'P24A'),
